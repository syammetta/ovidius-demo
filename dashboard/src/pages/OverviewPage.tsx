        ...
        >
          ...
          <div className="relative z-10 max-w-3xl space-y-5">
            ...
            <p className="text-base md:text-lg text-[var(--text-secondary)] leading-relaxed">
              This demo showcases an end-to-end retrieval-augmented generation system
              built on the Anthropic stack with measurable quality, observable pipeline
              stages, and citation-backed answers delivered through FastAPI.
            </p>
